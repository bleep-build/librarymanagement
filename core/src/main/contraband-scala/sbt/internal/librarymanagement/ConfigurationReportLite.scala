...
final class ConfigurationReportLite private (val configuration: String, val details: Vector[bleep.nosbt.librarymanagement.OrganizationArtifactReport])
...
object ConfigurationReportLite {
  ...
  def apply(configuration: String, details: Vector[bleep.nosbt.librarymanagement.OrganizationArtifactReport]): ConfigurationReportLite =
    new ConfigurationReportLite(configuration, details)
}
