...
final class SemComparator private (
    ...
    val tags: Seq[String]
) extends bleep.nosbt.internal.librarymanagement.SemComparatorExtra
    with Serializable {
  ...
  override def toString: String =
    this.toStringImpl
  private def copy(
      op: bleep.nosbt.internal.librarymanagement.SemSelOperator = op,
      major: Option[Long] = major,
      minor: Option[Long] = minor,
      patch: Option[Long] = patch,
...
object SemComparator extends bleep.nosbt.internal.librarymanagement.SemComparatorFunctions {
  ...
  def apply(
      op: bleep.nosbt.internal.librarymanagement.SemSelOperator,
      major: Option[Long],
      minor: Option[Long],
      patch: Option[Long],
      tags: Seq[String]
  ): SemComparator = new SemComparator(op, major, minor, patch, tags)
}
