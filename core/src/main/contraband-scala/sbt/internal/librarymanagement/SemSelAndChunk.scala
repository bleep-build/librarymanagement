...
final class SemSelAndChunk private (val comparators: Seq[bleep.nosbt.internal.librarymanagement.SemComparator]) extends Serializable {
  ...
  private def copy(comparators: Seq[bleep.nosbt.internal.librarymanagement.SemComparator]): SemSelAndChunk =
