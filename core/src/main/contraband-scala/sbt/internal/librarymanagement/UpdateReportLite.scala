...
final class UpdateReportLite private (val configurations: Vector[bleep.nosbt.internal.librarymanagement.ConfigurationReportLite]) extends Serializable {
  ...
  private def copy(configurations: Vector[bleep.nosbt.internal.librarymanagement.ConfigurationReportLite]): UpdateReportLite =
