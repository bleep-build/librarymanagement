...
final class Caller private (
  ...
  override def toString: String =
    s"$caller"
  private def copy(
      caller: bleep.nosbt.librarymanagement.ModuleID = caller,
      callerConfigurations: Vector[bleep.nosbt.librarymanagement.ConfigRef] = callerConfigurations,
      callerExtraAttributes: Map[String, String] = callerExtraAttributes,
      isForceDependency: Boolean = isForceDependency,
      isChangingDependency: Boolean = isChangingDependency,
      isTransitiveDependency: Boolean = isTransitiveDependency,
      isDirectlyForceDependency: Boolean = isDirectlyForceDependency
  ): Caller =
...
object Caller {
  ...
  def apply(
      caller: bleep.nosbt.librarymanagement.ModuleID,
      callerConfigurations: Vector[bleep.nosbt.librarymanagement.ConfigRef],
