...
trait ChainedResolverFormats { self: bleep.nosbt.librarymanagement.ResolverFormats & sjsonnew.BasicJsonProtocol =>
  implicit lazy val ChainedResolverFormat: JsonFormat[bleep.nosbt.librarymanagement.ChainedResolver] =
    new JsonFormat[bleep.nosbt.librarymanagement.ChainedResolver] {
