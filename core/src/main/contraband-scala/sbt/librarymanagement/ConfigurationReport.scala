...
final class ConfigurationReport private (
    ...
    val details: Vector[bleep.nosbt.librarymanagement.OrganizationArtifactReport]
) extends bleep.nosbt.librarymanagement.ConfigurationReportExtra
    with Serializable {
  ...
  private def copy(
      configuration: bleep.nosbt.librarymanagement.ConfigRef = configuration,
      modules: Vector[bleep.nosbt.librarymanagement.ModuleReport] = modules,
      details: Vector[bleep.nosbt.librarymanagement.OrganizationArtifactReport] = details
  ): ConfigurationReport =
...
object ConfigurationReport {
  ...
  def apply(
      configuration: bleep.nosbt.librarymanagement.ConfigRef,
      modules: Vector[bleep.nosbt.librarymanagement.ModuleReport],
      details: Vector[bleep.nosbt.librarymanagement.OrganizationArtifactReport]
  ): ConfigurationReport = new ConfigurationReport(configuration, modules, details)
}
