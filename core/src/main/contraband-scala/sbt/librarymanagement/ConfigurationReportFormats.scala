...
trait ConfigurationReportFormats {
  self: bleep.nosbt.librarymanagement.ConfigRefFormats & bleep.nosbt.librarymanagement.ModuleReportFormats &
    bleep.nosbt.librarymanagement.OrganizationArtifactReportFormats & sjsonnew.BasicJsonProtocol =>
  implicit lazy val ConfigurationReportFormat: JsonFormat[bleep.nosbt.librarymanagement.ConfigurationReport] =
    new JsonFormat[bleep.nosbt.librarymanagement.ConfigurationReport] {
