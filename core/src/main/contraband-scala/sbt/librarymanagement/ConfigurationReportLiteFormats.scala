...
trait ConfigurationReportLiteFormats { self: bleep.nosbt.librarymanagement.OrganizationArtifactReportFormats & sjsonnew.BasicJsonProtocol =>
  implicit lazy val ConfigurationReportLiteFormat: JsonFormat[bleep.nosbt.internal.librarymanagement.ConfigurationReportLite] =
    new JsonFormat[bleep.nosbt.internal.librarymanagement.ConfigurationReportLite] {
