...
trait ConflictManagerFormats { self: sjsonnew.BasicJsonProtocol =>
  implicit lazy val ConflictManagerFormat: JsonFormat[bleep.nosbt.librarymanagement.ConflictManager] =
    new JsonFormat[bleep.nosbt.librarymanagement.ConflictManager] {
