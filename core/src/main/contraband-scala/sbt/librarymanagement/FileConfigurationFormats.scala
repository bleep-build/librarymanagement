...
trait FileConfigurationFormats { self: sjsonnew.BasicJsonProtocol =>
  implicit lazy val FileConfigurationFormat: JsonFormat[bleep.nosbt.librarymanagement.FileConfiguration] =
    new JsonFormat[bleep.nosbt.librarymanagement.FileConfiguration] {
