...
final class FileRepository private (
    ...
    val configuration: bleep.nosbt.librarymanagement.FileConfiguration
  ...
  private def copy(
      ...
      configuration: bleep.nosbt.librarymanagement.FileConfiguration = configuration
  ): FileRepository =
...
object FileRepository {
  def apply(name: String, configuration: bleep.nosbt.librarymanagement.FileConfiguration, patterns: bleep.nosbt.librarymanagement.Patterns) =
    new FileRepository(name, patterns, configuration)
  def apply(name: String, patterns: bleep.nosbt.librarymanagement.Patterns, configuration: bleep.nosbt.librarymanagement.FileConfiguration): FileRepository =
    new FileRepository(name, patterns, configuration)
}
