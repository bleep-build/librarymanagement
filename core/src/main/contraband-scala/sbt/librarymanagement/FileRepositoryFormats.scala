...
trait FileRepositoryFormats {
  ...
  implicit lazy val FileRepositoryFormat: JsonFormat[bleep.nosbt.librarymanagement.FileRepository] =
    new JsonFormat[bleep.nosbt.librarymanagement.FileRepository] {
