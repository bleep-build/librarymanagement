...
final class GetClassifiersConfiguration private (
    ...
    val docArtifactTypes: Vector[String]
) extends Serializable {

  override def equals(o: Any): Boolean = this.eq(o.asInstanceOf[AnyRef]) || (o match {
    case x: GetClassifiersConfiguration =>
      (this.module == x.module) && (this.excludes == x.excludes) && (this.updateConfiguration == x.updateConfiguration) && (this.sourceArtifactTypes == x.sourceArtifactTypes) && (this.docArtifactTypes == x.docArtifactTypes)
    case _ => false
  })
  ...
  private def copy(
      module: bleep.nosbt.librarymanagement.GetClassifiersModule = module,
      excludes: Vector[scala.Tuple2[bleep.nosbt.librarymanagement.ModuleID, scala.Vector[bleep.nosbt.librarymanagement.ConfigRef]]] = excludes,
      updateConfiguration: bleep.nosbt.librarymanagement.UpdateConfiguration = updateConfiguration,
      sourceArtifactTypes: Vector[String] = sourceArtifactTypes,
      docArtifactTypes: Vector[String] = docArtifactTypes
  ...
  def withModule(module: bleep.nosbt.librarymanagement.GetClassifiersModule): GetClassifiersConfiguration =
    copy(module = module)
  def withExcludes(
      excludes: Vector[scala.Tuple2[bleep.nosbt.librarymanagement.ModuleID, scala.Vector[bleep.nosbt.librarymanagement.ConfigRef]]]
  ): GetClassifiersConfiguration =
...
object GetClassifiersConfiguration {
  ...
  def apply(
      module: bleep.nosbt.librarymanagement.GetClassifiersModule,
      excludes: Vector[scala.Tuple2[bleep.nosbt.librarymanagement.ModuleID, scala.Vector[bleep.nosbt.librarymanagement.ConfigRef]]],
      updateConfiguration: bleep.nosbt.librarymanagement.UpdateConfiguration,
      sourceArtifactTypes: Vector[String],
      docArtifactTypes: Vector[String]
  ): GetClassifiersConfiguration = new GetClassifiersConfiguration(module, excludes, updateConfiguration, sourceArtifactTypes, docArtifactTypes)
}
