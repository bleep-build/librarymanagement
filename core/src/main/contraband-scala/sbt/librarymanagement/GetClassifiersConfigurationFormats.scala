...
trait GetClassifiersConfigurationFormats {
  self: bleep.nosbt.librarymanagement.GetClassifiersModuleFormats & bleep.nosbt.librarymanagement.ModuleIDFormats &
    bleep.nosbt.librarymanagement.ConfigRefFormats & bleep.nosbt.librarymanagement.UpdateConfigurationFormats & sjsonnew.BasicJsonProtocol =>
  implicit lazy val GetClassifiersConfigurationFormat: JsonFormat[bleep.nosbt.librarymanagement.GetClassifiersConfiguration] =
    new JsonFormat[bleep.nosbt.librarymanagement.GetClassifiersConfiguration] {
      override def read[J](__jsOpt: Option[J], unbuilder: Unbuilder[J]): bleep.nosbt.librarymanagement.GetClassifiersConfiguration =
        __jsOpt match {
          case Some(__js) =>
            ...
            val excludes = unbuilder
              .readField[Vector[scala.Tuple2[bleep.nosbt.librarymanagement.ModuleID, scala.Vector[bleep.nosbt.librarymanagement.ConfigRef]]]]("excludes")
