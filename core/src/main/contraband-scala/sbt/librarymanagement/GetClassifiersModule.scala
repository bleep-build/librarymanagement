...
final class GetClassifiersModule private (
  ...
  override def equals(o: Any): Boolean = this.eq(o.asInstanceOf[AnyRef]) || (o match {
    case x: GetClassifiersModule =>
      (this.id == x.id) && (this.scalaModuleInfo == x.scalaModuleInfo) && (this.dependencies == x.dependencies) && (this.configurations == x.configurations) && (this.classifiers == x.classifiers)
    case _ => false
  })
  ...
  private def copy(
      id: bleep.nosbt.librarymanagement.ModuleID = id,
...
object GetClassifiersModule {
  ...
  def apply(
      id: bleep.nosbt.librarymanagement.ModuleID,
  ...
  ): GetClassifiersModule = new GetClassifiersModule(id, scalaModuleInfo, dependencies, configurations, classifiers)
  def apply(
      id: bleep.nosbt.librarymanagement.ModuleID,
      ...
      configurations: Vector[bleep.nosbt.librarymanagement.Configuration],
      classifiers: Vector[String]
  ): GetClassifiersModule = new GetClassifiersModule(id, Option(scalaModuleInfo), dependencies, configurations, classifiers)
}
