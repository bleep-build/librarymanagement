...
trait GetClassifiersModuleFormats {
  self: bleep.nosbt.librarymanagement.ModuleIDFormats & bleep.nosbt.librarymanagement.ScalaModuleInfoFormats &
    bleep.nosbt.librarymanagement.ConfigurationFormats & sjsonnew.BasicJsonProtocol =>
  implicit lazy val GetClassifiersModuleFormat: JsonFormat[bleep.nosbt.librarymanagement.GetClassifiersModule] =
    new JsonFormat[bleep.nosbt.librarymanagement.GetClassifiersModule] {
