...
trait IvyFileConfigurationFormats { self: bleep.nosbt.librarymanagement.ScalaModuleInfoFormats & sjsonnew.BasicJsonProtocol =>
  implicit lazy val IvyFileConfigurationFormat: JsonFormat[bleep.nosbt.librarymanagement.IvyFileConfiguration] =
    new JsonFormat[bleep.nosbt.librarymanagement.IvyFileConfiguration] {
