...
final class KeyFileAuthentication private (val user: String, val keyfile: java.io.File, val password: Option[String])
    extends bleep.nosbt.librarymanagement.SshAuthentication()
    with Serializable {
