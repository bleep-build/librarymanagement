...
trait KeyFileAuthenticationFormats { self: sjsonnew.BasicJsonProtocol =>
  implicit lazy val KeyFileAuthenticationFormat: JsonFormat[bleep.nosbt.librarymanagement.KeyFileAuthentication] =
    new JsonFormat[bleep.nosbt.librarymanagement.KeyFileAuthentication] {
