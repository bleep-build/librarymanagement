...
final class MakePomConfiguration private (
  ...
  private def copy(
      file: Option[java.io.File] = file,
      moduleInfo: Option[bleep.nosbt.librarymanagement.ModuleInfo] = moduleInfo,
      configurations: Option[scala.Vector[bleep.nosbt.librarymanagement.Configuration]] = configurations,
      extra: Option[scala.xml.NodeSeq] = extra,
      process: scala.Function1[scala.xml.Node, scala.xml.Node] = process,
      filterRepositories: scala.Function1[bleep.nosbt.librarymanagement.MavenRepository, Boolean] = filterRepositories,
      allRepositories: Boolean = allRepositories,
      includeTypes: Set[String] = includeTypes
...
object MakePomConfiguration extends bleep.nosbt.librarymanagement.MakePomConfigurationFunctions {
  ...
  def apply(
      ...
      moduleInfo: Option[bleep.nosbt.librarymanagement.ModuleInfo],
      configurations: Option[scala.Vector[bleep.nosbt.librarymanagement.Configuration]],
      extra: Option[scala.xml.NodeSeq],
      process: scala.Function1[scala.xml.Node, scala.xml.Node],
      filterRepositories: scala.Function1[bleep.nosbt.librarymanagement.MavenRepository, Boolean],
      allRepositories: Boolean,
      includeTypes: Set[String]
  ): MakePomConfiguration = new MakePomConfiguration(file, moduleInfo, configurations, extra, process, filterRepositories, allRepositories, includeTypes)
  def apply(
      file: java.io.File,
      moduleInfo: bleep.nosbt.librarymanagement.ModuleInfo,
      configurations: scala.Vector[bleep.nosbt.librarymanagement.Configuration],
      extra: scala.xml.NodeSeq,
      process: scala.Function1[scala.xml.Node, scala.xml.Node],
      filterRepositories: scala.Function1[bleep.nosbt.librarymanagement.MavenRepository, Boolean],
      allRepositories: Boolean,
      includeTypes: Set[String]
