...
/** An instance of maven CACHE directory. You cannot treat a cache directory the same as a a remote repository because the metadata is different (see Aether ML
  * discussion).
  */
final class MavenCache private (name: String, root: String, localIfFile: Boolean, val rootFile: java.io.File)
