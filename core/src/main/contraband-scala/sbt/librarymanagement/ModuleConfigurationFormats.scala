...
trait ModuleConfigurationFormats { self: bleep.nosbt.librarymanagement.ResolverFormats & sjsonnew.BasicJsonProtocol =>
  implicit lazy val ModuleConfigurationFormat: JsonFormat[bleep.nosbt.librarymanagement.ModuleConfiguration] =
    new JsonFormat[bleep.nosbt.librarymanagement.ModuleConfiguration] {
