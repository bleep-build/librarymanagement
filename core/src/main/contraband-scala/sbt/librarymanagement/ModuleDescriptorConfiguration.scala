...
final class ModuleDescriptorConfiguration private (
    ...
    val conflictManager: bleep.nosbt.librarymanagement.ConflictManager
) extends bleep.nosbt.librarymanagement.ModuleSettings(validate, scalaModuleInfo)
    with Serializable {

  private def this(module: bleep.nosbt.librarymanagement.ModuleID, moduleInfo: bleep.nosbt.librarymanagement.ModuleInfo) = this(
    false,
    None,
    module,
    moduleInfo,
    ...
    bleep.nosbt.librarymanagement.Configurations.default,
    Option(bleep.nosbt.librarymanagement.Configurations.Compile),
    bleep.nosbt.librarymanagement.ConflictManager.default
  )

  override def equals(o: Any): Boolean = this.eq(o.asInstanceOf[AnyRef]) || (o match {
    case x: ModuleDescriptorConfiguration =>
  ...
  private def copy(
      ...
      scalaModuleInfo: Option[bleep.nosbt.librarymanagement.ScalaModuleInfo] = scalaModuleInfo,
      module: bleep.nosbt.librarymanagement.ModuleID = module,
      moduleInfo: bleep.nosbt.librarymanagement.ModuleInfo = moduleInfo,
      dependencies: Vector[bleep.nosbt.librarymanagement.ModuleID] = dependencies,
      overrides: Vector[bleep.nosbt.librarymanagement.ModuleID] = overrides,
      excludes: Vector[bleep.nosbt.librarymanagement.InclExclRule] = excludes,
      ivyXML: scala.xml.NodeSeq = ivyXML,
      configurations: Vector[bleep.nosbt.librarymanagement.Configuration] = configurations,
      defaultConfiguration: Option[bleep.nosbt.librarymanagement.Configuration] = defaultConfiguration,
      conflictManager: bleep.nosbt.librarymanagement.ConflictManager = conflictManager
...
object ModuleDescriptorConfiguration extends bleep.nosbt.librarymanagement.InlineConfigurationFunctions {
  ...
  def apply(module: bleep.nosbt.librarymanagement.ModuleID, moduleInfo: bleep.nosbt.librarymanagement.ModuleInfo): ModuleDescriptorConfiguration =
    new ModuleDescriptorConfiguration(module, moduleInfo)
  def apply(
      validate: Boolean,
      scalaModuleInfo: Option[bleep.nosbt.librarymanagement.ScalaModuleInfo],
      module: bleep.nosbt.librarymanagement.ModuleID,
      moduleInfo: bleep.nosbt.librarymanagement.ModuleInfo,
      dependencies: Vector[bleep.nosbt.librarymanagement.ModuleID],
      overrides: Vector[bleep.nosbt.librarymanagement.ModuleID],
      excludes: Vector[bleep.nosbt.librarymanagement.InclExclRule],
      ivyXML: scala.xml.NodeSeq,
      configurations: Vector[bleep.nosbt.librarymanagement.Configuration],
      defaultConfiguration: Option[bleep.nosbt.librarymanagement.Configuration],
      conflictManager: bleep.nosbt.librarymanagement.ConflictManager
  ): ModuleDescriptorConfiguration = new ModuleDescriptorConfiguration(
    validate,
    scalaModuleInfo,
    module,
    moduleInfo,
  ...
  def apply(
      validate: Boolean,
      scalaModuleInfo: bleep.nosbt.librarymanagement.ScalaModuleInfo,
      module: bleep.nosbt.librarymanagement.ModuleID,
      moduleInfo: bleep.nosbt.librarymanagement.ModuleInfo,
      dependencies: Vector[bleep.nosbt.librarymanagement.ModuleID],
      overrides: Vector[bleep.nosbt.librarymanagement.ModuleID],
      ...
      ivyXML: scala.xml.NodeSeq,
      configurations: Vector[bleep.nosbt.librarymanagement.Configuration],
      defaultConfiguration: bleep.nosbt.librarymanagement.Configuration,
      conflictManager: bleep.nosbt.librarymanagement.ConflictManager
  ): ModuleDescriptorConfiguration = new ModuleDescriptorConfiguration(
    validate,
    Option(scalaModuleInfo),
    module,
    moduleInfo,
    dependencies,
    overrides,
