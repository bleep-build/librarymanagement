...
final class ModuleID private (
...
) extends bleep.nosbt.librarymanagement.ModuleIDExtra
    with Serializable {

  private def this(organization: String, name: String, revision: String) = this(
    organization,
    name,
    revision,
    None,
  ...
  override def equals(o: Any): Boolean = this.eq(o.asInstanceOf[AnyRef]) || (o match {
    case x: ModuleID =>
      (this.organization == x.organization) && (this.name == x.name) && (this.revision == x.revision) && (this.configurations == x.configurations) && (this.isChanging == x.isChanging) && (this.isTransitive == x.isTransitive) && (this.isForce == x.isForce) && (this.explicitArtifacts == x.explicitArtifacts) && (this.inclusions == x.inclusions) && (this.exclusions == x.exclusions) && (this.extraAttributes == x.extraAttributes) && (this.crossVersion == x.crossVersion) && (this.branchName == x.branchName)
    case _ => false
  })
  ...
  private def copy(
      ...
      explicitArtifacts: Vector[bleep.nosbt.librarymanagement.Artifact] = explicitArtifacts,
      inclusions: Vector[bleep.nosbt.librarymanagement.InclExclRule] = inclusions,
      exclusions: Vector[bleep.nosbt.librarymanagement.InclExclRule] = exclusions,
      extraAttributes: Map[String, String] = extraAttributes,
      crossVersion: bleep.nosbt.librarymanagement.CrossVersion = crossVersion,
...
object ModuleID extends bleep.nosbt.librarymanagement.ModuleIDFunctions {
  ...
  def apply(
      ...
      isForce: Boolean,
      explicitArtifacts: Vector[bleep.nosbt.librarymanagement.Artifact],
      inclusions: Vector[bleep.nosbt.librarymanagement.InclExclRule],
      exclusions: Vector[bleep.nosbt.librarymanagement.InclExclRule],
      extraAttributes: Map[String, String],
      crossVersion: bleep.nosbt.librarymanagement.CrossVersion,
