...
trait ModuleIDFormats {
  self: bleep.nosbt.librarymanagement.ArtifactFormats & bleep.nosbt.librarymanagement.InclExclRuleFormats & bleep.nosbt.librarymanagement.CrossVersionFormats &
    bleep.nosbt.librarymanagement.DisabledFormats & bleep.nosbt.librarymanagement.BinaryFormats & bleep.nosbt.librarymanagement.ConstantFormats &
    bleep.nosbt.librarymanagement.PatchFormats & bleep.nosbt.librarymanagement.FullFormats & bleep.nosbt.librarymanagement.For3Use2_13Formats &
    bleep.nosbt.librarymanagement.For2_13Use3Formats & sjsonnew.BasicJsonProtocol =>
    ...
    override def read[J](__jsOpt: Option[J], unbuilder: Unbuilder[J]): bleep.nosbt.librarymanagement.ModuleID =
      __jsOpt match {
        case Some(__js) =>
          ...
          unbuilder.endObject()
          bleep.nosbt.librarymanagement.ModuleID(
            organization,
            name,
            revision,
            configurations,
