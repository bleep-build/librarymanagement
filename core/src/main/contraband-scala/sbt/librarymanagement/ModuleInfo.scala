...
final class ModuleInfo private (
    ...
    val developers: Vector[bleep.nosbt.librarymanagement.Developer]
  ...
  override def equals(o: Any): Boolean = this.eq(o.asInstanceOf[AnyRef]) || (o match {
    case x: ModuleInfo =>
      (this.nameFormal == x.nameFormal) && (this.description == x.description) && (this.homepage == x.homepage) && (this.startYear == x.startYear) && (this.licenses == x.licenses) && (this.organizationName == x.organizationName) && (this.organizationHomepage == x.organizationHomepage) && (this.scmInfo == x.scmInfo) && (this.developers == x.developers)
    case _ => false
  })
  ...
  private def copy(
      nameFormal: String = nameFormal,
      description: String = description,
      homepage: Option[java.net.URL] = homepage,
      startYear: Option[Int] = startYear,
      licenses: Vector[scala.Tuple2[String, java.net.URL]] = licenses,
      organizationName: String = organizationName,
      organizationHomepage: Option[java.net.URL] = organizationHomepage,
      scmInfo: Option[bleep.nosbt.librarymanagement.ScmInfo] = scmInfo,
      developers: Vector[bleep.nosbt.librarymanagement.Developer] = developers
  ): ModuleInfo =
...
object ModuleInfo {
  ...
  def apply(
      ...
      licenses: Vector[scala.Tuple2[String, java.net.URL]],
      organizationName: String,
      organizationHomepage: Option[java.net.URL],
      scmInfo: Option[bleep.nosbt.librarymanagement.ScmInfo],
      developers: Vector[bleep.nosbt.librarymanagement.Developer]
  ): ModuleInfo = new ModuleInfo(nameFormal, description, homepage, startYear, licenses, organizationName, organizationHomepage, scmInfo, developers)
}
