...
final class ModuleReport private (
    ...
    val callers: Vector[bleep.nosbt.librarymanagement.Caller]
) extends bleep.nosbt.librarymanagement.ModuleReportExtra
    with Serializable {

  private def this(
      module: bleep.nosbt.librarymanagement.ModuleID,
      artifacts: Vector[scala.Tuple2[bleep.nosbt.librarymanagement.Artifact, java.io.File]],
      missingArtifacts: Vector[bleep.nosbt.librarymanagement.Artifact]
  ) = this(
    module,
    artifacts,
    missingArtifacts,
  ...
  private def copy(
      ...
      artifacts: Vector[scala.Tuple2[bleep.nosbt.librarymanagement.Artifact, java.io.File]] = artifacts,
      missingArtifacts: Vector[bleep.nosbt.librarymanagement.Artifact] = missingArtifacts,
      status: Option[String] = status,
      publicationDate: Option[java.util.Calendar] = publicationDate,
      ...
      configurations: Vector[bleep.nosbt.librarymanagement.ConfigRef] = configurations,
      licenses: Vector[scala.Tuple2[String, Option[String]]] = licenses,
      callers: Vector[bleep.nosbt.librarymanagement.Caller] = callers
  ): ModuleReport =
    new ModuleReport(
      module,
      artifacts,
...
object ModuleReport {
  ...
  def apply(
      ...
      artifacts: Vector[scala.Tuple2[bleep.nosbt.librarymanagement.Artifact, java.io.File]],
      missingArtifacts: Vector[bleep.nosbt.librarymanagement.Artifact]
  ): ModuleReport = new ModuleReport(module, artifacts, missingArtifacts)
  def apply(
      module: bleep.nosbt.librarymanagement.ModuleID,
      artifacts: Vector[scala.Tuple2[bleep.nosbt.librarymanagement.Artifact, java.io.File]],
      missingArtifacts: Vector[bleep.nosbt.librarymanagement.Artifact],
      status: Option[String],
      publicationDate: Option[java.util.Calendar],
      resolver: Option[String],
      artifactResolver: Option[String],
      evicted: Boolean,
      evictedData: Option[String],
      evictedReason: Option[String],
      problem: Option[String],
      homepage: Option[String],
      extraAttributes: Map[String, String],
      isDefault: Option[Boolean],
      branch: Option[String],
      configurations: Vector[bleep.nosbt.librarymanagement.ConfigRef],
      licenses: Vector[scala.Tuple2[String, Option[String]]],
      callers: Vector[bleep.nosbt.librarymanagement.Caller]
