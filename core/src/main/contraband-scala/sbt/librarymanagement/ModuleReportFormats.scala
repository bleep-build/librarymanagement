...
trait ModuleReportFormats {
  self: bleep.nosbt.librarymanagement.ModuleIDFormats & bleep.nosbt.librarymanagement.ArtifactFormats & bleep.nosbt.librarymanagement.ConfigRefFormats &
    bleep.nosbt.librarymanagement.CallerFormats & sjsonnew.BasicJsonProtocol =>
    ...
    override def read[J](__jsOpt: Option[J], unbuilder: Unbuilder[J]): bleep.nosbt.librarymanagement.ModuleReport =
      __jsOpt match {
        case Some(__js) =>
          ...
          unbuilder.endObject()
          bleep.nosbt.librarymanagement.ModuleReport(
            module,
            artifacts,
            missingArtifacts,
            status,
