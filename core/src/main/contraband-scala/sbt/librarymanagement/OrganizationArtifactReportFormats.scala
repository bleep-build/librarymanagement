...
trait OrganizationArtifactReportFormats { self: bleep.nosbt.librarymanagement.ModuleReportFormats & sjsonnew.BasicJsonProtocol =>
  implicit lazy val OrganizationArtifactReportFormat: JsonFormat[bleep.nosbt.librarymanagement.OrganizationArtifactReport] =
    new JsonFormat[bleep.nosbt.librarymanagement.OrganizationArtifactReport] {
