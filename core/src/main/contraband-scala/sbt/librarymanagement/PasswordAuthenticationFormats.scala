...
trait PasswordAuthenticationFormats { self: sjsonnew.BasicJsonProtocol =>
  implicit lazy val PasswordAuthenticationFormat: JsonFormat[bleep.nosbt.librarymanagement.PasswordAuthentication] =
    new JsonFormat[bleep.nosbt.librarymanagement.PasswordAuthentication] {
