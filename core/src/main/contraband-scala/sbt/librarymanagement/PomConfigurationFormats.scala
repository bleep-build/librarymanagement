...
trait PomConfigurationFormats { self: bleep.nosbt.librarymanagement.ScalaModuleInfoFormats & sjsonnew.BasicJsonProtocol =>
  implicit lazy val PomConfigurationFormat: JsonFormat[bleep.nosbt.librarymanagement.PomConfiguration] =
    new JsonFormat[bleep.nosbt.librarymanagement.PomConfiguration] {
