...
final class PublishConfiguration private (
  ...
  override def equals(o: Any): Boolean = this.eq(o.asInstanceOf[AnyRef]) || (o match {
    case x: PublishConfiguration =>
      (this.publishMavenStyle == x.publishMavenStyle) && (this.deliverIvyPattern == x.deliverIvyPattern) && (this.status == x.status) && (this.configurations == x.configurations) && (this.resolverName == x.resolverName) && (this.artifacts == x.artifacts) && (this.checksums == x.checksums) && (this.logging == x.logging) && (this.overwrite == x.overwrite)
    case _ => false
  })
  ...
  private def copy(
      publishMavenStyle: Boolean = publishMavenStyle,
      deliverIvyPattern: Option[String] = deliverIvyPattern,
      status: Option[String] = status,
      configurations: Option[scala.Vector[bleep.nosbt.librarymanagement.ConfigRef]] = configurations,
      resolverName: Option[String] = resolverName,
      artifacts: Vector[scala.Tuple2[bleep.nosbt.librarymanagement.Artifact, java.io.File]] = artifacts,
      checksums: scala.Vector[String] = checksums,
      logging: Option[bleep.nosbt.librarymanagement.UpdateLogging] = logging,
...
object PublishConfiguration {
  ...
  def apply(
      ...
      deliverIvyPattern: Option[String],
      status: Option[String],
      configurations: Option[scala.Vector[bleep.nosbt.librarymanagement.ConfigRef]],
      resolverName: Option[String],
      artifacts: Vector[scala.Tuple2[bleep.nosbt.librarymanagement.Artifact, java.io.File]],
      checksums: scala.Vector[String],
      logging: Option[bleep.nosbt.librarymanagement.UpdateLogging],
      overwrite: Boolean
  ): PublishConfiguration =
    new PublishConfiguration(publishMavenStyle, deliverIvyPattern, status, configurations, resolverName, artifacts, checksums, logging, overwrite)
  def apply(
      ...
      status: String,
      configurations: scala.Vector[bleep.nosbt.librarymanagement.ConfigRef],
      resolverName: String,
      artifacts: Vector[scala.Tuple2[bleep.nosbt.librarymanagement.Artifact, java.io.File]],
      checksums: scala.Vector[String],
