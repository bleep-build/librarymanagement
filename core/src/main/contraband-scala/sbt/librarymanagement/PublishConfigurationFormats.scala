...
trait PublishConfigurationFormats {
  self: bleep.nosbt.librarymanagement.ConfigRefFormats & bleep.nosbt.librarymanagement.ArtifactFormats & bleep.nosbt.librarymanagement.UpdateLoggingFormats &
    sjsonnew.BasicJsonProtocol =>
  implicit lazy val PublishConfigurationFormat: JsonFormat[bleep.nosbt.librarymanagement.PublishConfiguration] =
    new JsonFormat[bleep.nosbt.librarymanagement.PublishConfiguration] {
      override def read[J](__jsOpt: Option[J], unbuilder: Unbuilder[J]): bleep.nosbt.librarymanagement.PublishConfiguration =
        __jsOpt match {
          case Some(__js) =>
            ...
            unbuilder.endObject()
            bleep.nosbt.librarymanagement.PublishConfiguration(
              publishMavenStyle,
              deliverIvyPattern,
              status,
              configurations,
