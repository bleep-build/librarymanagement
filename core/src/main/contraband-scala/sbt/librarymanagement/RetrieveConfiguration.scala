...
final class RetrieveConfiguration private (
    ...
    val sync: Boolean,
    val configurationsToRetrieve: Option[scala.Vector[bleep.nosbt.librarymanagement.ConfigRef]]
  ...
  override def equals(o: Any): Boolean = this.eq(o.asInstanceOf[AnyRef]) || (o match {
    case x: RetrieveConfiguration =>
      (this.retrieveDirectory == x.retrieveDirectory) && (this.outputPattern == x.outputPattern) && (this.sync == x.sync) && (this.configurationsToRetrieve == x.configurationsToRetrieve)
    case _ => false
  })
  ...
  private def copy(
      retrieveDirectory: Option[java.io.File] = retrieveDirectory,
      outputPattern: Option[String] = outputPattern,
      sync: Boolean = sync,
      configurationsToRetrieve: Option[scala.Vector[bleep.nosbt.librarymanagement.ConfigRef]] = configurationsToRetrieve
...
object RetrieveConfiguration {
  ...
  def apply(retrieveDirectory: Option[java.io.File], outputPattern: Option[String]): RetrieveConfiguration =
    new RetrieveConfiguration(retrieveDirectory, outputPattern)
  def apply(retrieveDirectory: java.io.File, outputPattern: String): RetrieveConfiguration =
    new RetrieveConfiguration(Option(retrieveDirectory), Option(outputPattern))
  def apply(
      retrieveDirectory: Option[java.io.File],
      outputPattern: Option[String],
      sync: Boolean,
      configurationsToRetrieve: Option[scala.Vector[bleep.nosbt.librarymanagement.ConfigRef]]
  ): RetrieveConfiguration = new RetrieveConfiguration(retrieveDirectory, outputPattern, sync, configurationsToRetrieve)
  def apply(
      retrieveDirectory: java.io.File,
      outputPattern: String,
      sync: Boolean,
      configurationsToRetrieve: scala.Vector[bleep.nosbt.librarymanagement.ConfigRef]
  ): RetrieveConfiguration = new RetrieveConfiguration(Option(retrieveDirectory), Option(outputPattern), sync, Option(configurationsToRetrieve))
}
