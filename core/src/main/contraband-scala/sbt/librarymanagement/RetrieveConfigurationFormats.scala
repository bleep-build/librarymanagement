...
trait RetrieveConfigurationFormats { self: bleep.nosbt.librarymanagement.ConfigRefFormats & sjsonnew.BasicJsonProtocol =>
  implicit lazy val RetrieveConfigurationFormat: JsonFormat[bleep.nosbt.librarymanagement.RetrieveConfiguration] =
    new JsonFormat[bleep.nosbt.librarymanagement.RetrieveConfiguration] {
