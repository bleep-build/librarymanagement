...
final class ScalaModuleInfo private (
  ...
  private def copy(
      scalaFullVersion: String = scalaFullVersion,
      scalaBinaryVersion: String = scalaBinaryVersion,
      configurations: Vector[bleep.nosbt.librarymanagement.Configuration] = configurations,
      checkExplicit: Boolean = checkExplicit,
      filterImplicit: Boolean = filterImplicit,
      overrideScalaVersion: Boolean = overrideScalaVersion,
      scalaOrganization: String = scalaOrganization,
      scalaArtifacts: scala.Vector[String] = scalaArtifacts
  ): ScalaModuleInfo =
    new ScalaModuleInfo(
      scalaFullVersion,
      scalaBinaryVersion,
...
object ScalaModuleInfo {
  ...
  def apply(
      ...
      filterImplicit: Boolean,
      overrideScalaVersion: Boolean
  ): ScalaModuleInfo = new ScalaModuleInfo(scalaFullVersion, scalaBinaryVersion, configurations, checkExplicit, filterImplicit, overrideScalaVersion)
  def apply(
      scalaFullVersion: String,
      scalaBinaryVersion: String,
      configurations: Vector[bleep.nosbt.librarymanagement.Configuration],
      ...
      scalaArtifacts: scala.Vector[String]
  ): ScalaModuleInfo = new ScalaModuleInfo(
    scalaFullVersion,
    scalaBinaryVersion,
    configurations,
    checkExplicit,
