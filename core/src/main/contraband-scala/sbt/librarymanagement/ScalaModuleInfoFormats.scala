...
trait ScalaModuleInfoFormats { self: bleep.nosbt.librarymanagement.ConfigurationFormats & sjsonnew.BasicJsonProtocol =>
  implicit lazy val ScalaModuleInfoFormat: JsonFormat[bleep.nosbt.librarymanagement.ScalaModuleInfo] =
    new JsonFormat[bleep.nosbt.librarymanagement.ScalaModuleInfo] {
      override def read[J](__jsOpt: Option[J], unbuilder: Unbuilder[J]): bleep.nosbt.librarymanagement.ScalaModuleInfo =
        __jsOpt match {
          case Some(__js) =>
            ...
            unbuilder.endObject()
            bleep.nosbt.librarymanagement.ScalaModuleInfo(
              scalaFullVersion,
              scalaBinaryVersion,
              configurations,
              checkExplicit,
