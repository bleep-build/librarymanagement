...
trait SftpRepositoryFormats {
  ...
  implicit lazy val SftpRepositoryFormat: JsonFormat[bleep.nosbt.librarymanagement.SftpRepository] =
    new JsonFormat[bleep.nosbt.librarymanagement.SftpRepository] {
