...
abstract class SshBasedRepository(name: String, patterns: bleep.nosbt.librarymanagement.Patterns, val connection: bleep.nosbt.librarymanagement.SshConnection)
    extends bleep.nosbt.librarymanagement.PatternsBasedRepository(name, patterns)
    with bleep.nosbt.librarymanagement.SshBasedRepositoryExtra
    with Serializable {
