...
trait UpdateConfigurationFormats {
  self: bleep.nosbt.librarymanagement.RetrieveConfigurationFormats & bleep.nosbt.librarymanagement.UpdateLoggingFormats &
    bleep.nosbt.internal.librarymanagement.formats.LogicalClockFormats & bleep.nosbt.librarymanagement.ArtifactTypeFilterFormats & sjsonnew.BasicJsonProtocol =>
  implicit lazy val UpdateConfigurationFormat: JsonFormat[bleep.nosbt.librarymanagement.UpdateConfiguration] =
    new JsonFormat[bleep.nosbt.librarymanagement.UpdateConfiguration] {
      override def read[J](__jsOpt: Option[J], unbuilder: Unbuilder[J]): bleep.nosbt.librarymanagement.UpdateConfiguration =
        __jsOpt match {
          case Some(__js) =>
            ...
            unbuilder.endObject()
            bleep.nosbt.librarymanagement.UpdateConfiguration(
              retrieveManaged,
              missingOk,
              logging,
              logicalClock,
