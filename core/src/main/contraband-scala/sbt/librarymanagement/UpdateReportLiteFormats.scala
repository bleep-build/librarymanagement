...
trait UpdateReportLiteFormats { self: bleep.nosbt.librarymanagement.ConfigurationReportLiteFormats & sjsonnew.BasicJsonProtocol =>
  implicit lazy val UpdateReportLiteFormat: JsonFormat[bleep.nosbt.internal.librarymanagement.UpdateReportLite] =
    new JsonFormat[bleep.nosbt.internal.librarymanagement.UpdateReportLite] {
