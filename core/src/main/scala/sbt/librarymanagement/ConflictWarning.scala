...
/** Provide warnings for cross version conflicts. A library foo_2.10 and foo_2.11 can potentially be both included on the library dependency graph by mistake,
  * but it won't be caught by eviction.
  */
